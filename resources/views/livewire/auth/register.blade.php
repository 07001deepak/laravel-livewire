            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Sign Up</button><span wire:loading>
                            <img src="{{ asset('images\loaders\Loading_1.gif') }}" alt="" width="50px">
                        </span>
